...
random = np.random.randint(2,100,size = (3,3))
print(random)
...
random.resize(3, 2)     # resizes the array in-place irrespective of the number of elements.
print(random)
#########################################################################
...
eigenvalues, eigenvectors = np.linalg.eig(random)
print(eigenvalues)
sorted_indices = np.argsort(eigenvalues)[::-1]
print(sorted_indices)
top_eigenvalue = eigenvalues[sorted_indices[0]]
print(f"Top Eigenvalue: {top_eigenvalue}") 
top_eigenvector = eigenvectors[:, sorted_indices[0]]
print(f"Top Eigenvector (Principal Component):\n {top_eigenvector}")
